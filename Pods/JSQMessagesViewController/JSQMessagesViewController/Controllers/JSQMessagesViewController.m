...
@property (weak, nonatomic) IBOutlet UIButton *buttonCheckUnCeck;
...
- (void)increaseHeightOfToolBar {
    [self.typingView setHidden:NO];
}

- (UIButton *)getCheckButton {
    return self.buttonCheckUnCeck;
}
...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(didupdateInternetConnection:)
                                                 name:@"updateInternetStatus"
                                               object:nil];
...
- (void)viewDidDisappear:(BOOL)animated
{
    ...
    [self.keyboardController endListeningForKeyboard];
        ...
        //MARK:- UpdateInternetStatus
-(void)didupdateInternetConnection:(NSNotification *) notification {
    NSString *reportInfo = notification.userInfo;
    CGFloat topbarHeight = ([UIApplication sharedApplication].statusBarFrame.size.height +
           (self.navigationController.navigationBar.frame.size.height ?: 0.0));
    UIView *headerView = [[UIView alloc] initWithFrame:CGRectMake(0, topbarHeight, _collectionView.bounds.size.width, 64)];
    UILabel *lblTitle = [[UILabel alloc] initWithFrame:CGRectMake(48, 5, _collectionView.bounds.size.width-54, 60)];
    UIImageView *imageNowifi = [[UIImageView alloc] initWithFrame:CGRectMake(16, 20, 24, 24)];
    
    if ([reportInfo isEqualToString:@"report"])
    {
    ...
    UIView *bottemView = [[UIView alloc] initWithFrame:CGRectMake(16, -115, _collectionView.bounds.size.width-32, 90)];
    ...
    UILabel *lblMsgSubTitle = [[UILabel alloc] initWithFrame:CGRectMake(8, lblMsgTitle.frame.size.height+12, bottemView.bounds.size.width-16, 50)];
        ...
        [button addTarget:self
                   action:@selector(btnUndu:)
         forControlEvents:UIControlEventTouchUpInside];
        [button setTitle:@"Undu" forState:UIControlStateNormal];
        ...
        [_inputToolbar addSubview:bottemView];
    ...
    }else if ([reportInfo isEqualToString:@""]) {
    ...
    /*
    //AnnounceMent
    [headerView setBackgroundColor:[UIColor colorWithRed:237/255.0 green:246/255.0 blue:255/255.0 alpha:1]];
        lblTitle.textColor = [UIColor colorWithRed:86/255.0 green:145/255.0 blue:200/255.0 alpha:1];
    lblTitle.text = @"All users will be reviewed between 2 March to 20 March and any suspicious users will be removed from the workspace.";
    [imageNowifi setImage:[UIImage imageNamed:@"megaphone"]];
