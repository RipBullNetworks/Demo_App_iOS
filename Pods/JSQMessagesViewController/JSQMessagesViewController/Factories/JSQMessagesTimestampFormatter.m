...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _dateTextAttributes = @{ NSFontAttributeName : [UIFont fontWithName:@"SFProDisplay-Semibold" size:14],
                                 NSForegroundColorAttributeName : color,
                                 NSParagraphStyleAttributeName : paragraphStyle };
        
        _timeTextAttributes = @{ NSFontAttributeName : [UIFont fontWithName:@"SFProDisplay-Semibold" size:14],
                                 NSForegroundColorAttributeName : color,
                                 NSParagraphStyleAttributeName : paragraphStyle };
    }
    return self;
