 ...
 */
@interface JSQGIFMediaItem : JSQMediaItem <JSQMessageMediaData, NSCoding, NSCopying>
@property (strong, nonatomic) YFGIFImageView *cachedImageView;
 ...
 */
- (instancetype)initWithImageData:(NSData *)image;
