...
- (void)viewDidLoad {
   ...
   // _arrMessageHistory = [[NSMutableArray alloc] init];
                    ...
                    if ([dictResponse[@"result"] isKindOfClass:[NSDictionary class]]) {
                        ...
                        NSArray *arr = dictResult[@"chats"];
                            ...
                            for (int i = 0; i < [arr count]; i++)
                            {
                                ...
                                NSString *strUser = [self getUsernameWithUserId:arrParticipants];
...
//            if([strUserID isEqualToString:dictUser[Key_Name]]){
//            [arrUserName addObject:@"You"];
//            }else{
